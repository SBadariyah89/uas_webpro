                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form onsubmit="return confirm('hapus data?')" class='d-inline' action="<?php echo e(url('mahasiswa/'.$item->nim)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpbelajar\cruduas\resources\views/datamahasiswa/index.blade.php ENDPATH**/ ?>